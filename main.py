...
url_megamarket = 'https://megamarket.ru/catalog/frukty-yagody-i-ovoshi/'
...
excel_data_megamarket = [['Наименование', 'Цена', 'Дата', 'Картинка']]
...
def megamarket_data():
    promotions = url_sberashan.findAll('li', class_='')
def ashan_data():
